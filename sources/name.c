...
/*   Updated: 2016/05/04 18:09:17 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*dispatch_num(int num)
{
	...
	if ((num > 10 && num <= 20) || num == 100)
		...
		str = machin_sup_triple(ft_itoa(num), str, 0);
	else if (num == 10 || num > 20)
		str = machin_sup_double(ft_itoa(num), str, 0);
	else if (num > 0)
		str = machin_sup_simple(ft_itoa(num), str, 0);
